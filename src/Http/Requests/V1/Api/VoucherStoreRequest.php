...
class VoucherStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'title' => ['string','max:255',Rule::unique(config('callmeaf-voucher.model'),'title')],
            'code' => ['string','size:' . config('callmeaf-voucher.code_length'),Rule::unique(config('callmeaf-voucher.model'),'code')],
